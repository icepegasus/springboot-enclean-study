								...
								<div class="table-responsive">
									<div align=right>
										<button type="button"
											...
											id="favorDeletetBtn">단골삭제</button>
									</div>
									<br>
									<table
										class="table table-striped table-bordered table-hover dataTable no-foote"
										id="favor_dataTables"
										aria-describedby="dataTables-example_info">
										<thead>
											<tr role="row">
												<th tabindex="0" class="sorting" style="width: 80px;"
													aria-controls="favor_dataTables" aria-sort="descending"
													rowspan="1" colspan="1">no.</th>
												<th tabindex="0" class="sorting" style="width: 80px;"
													aria-controls="favor_dataTables" aria-sort="ascending"
													rowspan="1" colspan="1">선택</th>
												<th tabindex="0" class="sorting"
													aria-controls="favor_dataTables" aria-sort="descending"
													rowspan="1" colspan="1">주유소코드</th>
												<th tabindex="0" class="sorting"
													aria-controls="favor_dataTables" aria-sort="ascending"
													rowspan="1" colspan="1">주유소명</th>
												<th tabindex="0" class="sorting"
													aria-controls="favor_dataTables" aria-sort="ascending"
													rowspan="1" colspan="1">대표자명</th>
												<th tabindex="0" class="sorting"
													aria-controls="favor_dataTables" aria-sort="ascending"
													rowspan="1" colspan="1">전화번호</th>
												<th tabindex="0" class="sorting"
													aria-controls="favor_dataTables" aria-sort="ascending"
													rowspan="1" colspan="1">주 소</th>
											</tr>
										</thead>
										<tbody>
							...
							<div>
								<div class="form-group">
									<form:form action="/favor" method="GET">
										...
										<button type="button"
											class="btn btn-outline btn btn-default btn-sm">조회</button>
								...
								<form name="stationSerch" method="post">
									<div class="table-responsive">
										<div align=right>
											<button type="button"
												class="btn btn-outline btn-default btn-sm"
												id="favorInsertBtn">단골등록</button>
										</div>
										<br>
										<table
											class="table table-striped table-bordered table-hover dataTable no-foote"
											id="station_dataTables"
											aria-describedby="dataTables-example_info">
											<thead>
												<tr role="row">
													<th tabindex="0" class="sorting" style="width: 80px;"
											...
											<tbody>
												<c:forEach var="favorSts" items="${favorStsList}" varStatus="index">
													<tr>
														...
														<td>
															<div class="form-group">
																<input type="checkbox" name="user_CheckBox" checked=""> <%-- value="${favorSts.ischecked}"> --%>
															</div>
														</td>
														<td>${favorSts.sid}</td>
